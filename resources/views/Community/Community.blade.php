        ...
        <main class="main container" id="main">
            ...
            <div class="profile-section">
                ...
                {{-- <form action="{{ route('join.community', ['community_name' => $community->community_name]) }}" method="POST">
                    @csrf
                    @if($isMember)
                        <button type="button" class="joined" onclick="toggleButton(this)"><span>Joined</span></button>
                    @else
        ...
        <div class="rightbar">
            ...
            <div class="section">
                ...
                <div class="section-item">
                    ...
                    <a href="{{ route('outprofile', ['username' => $community->user->user_name]) }}" onMouseOver="this.style.color='#878ed8'" onMouseOut="this.style.color='#9fa5b5'">
                        <p >View</p>
                    </a>
                </div>
            </div>
